...
function scene:create( event )
	...
	local animalwidgetGroup  = animalwidget:newAnimalWidget(0,2)
	...
	local levelText = display.newText("level : 2", display.contentWidth - 100, 50, native.systemFont, 18 )
	levelText.anchorX = 0
